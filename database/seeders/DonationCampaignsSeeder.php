...
class DonationCampaignsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $campaigns = [
            [
                'category_name_ar' => 'حملات الطوارئ',
                ...
                'description_en' => 'Urgent campaign to help earthquake victims in the affected area. We need to provide shelter, food, and medicine for those affected.',
            ...
            [
                'category_name_ar' => 'حملات التعليم',
                'title_ar' => 'حملة بناء مدرسة في القرية النائية',
                'title_en' => 'School Building Campaign in Remote Village',
                'description_ar' => 'حملة لبناء مدرسة في قرية نائية تفتقر للمرافق التعليمية. المدرسة ستخدم 200 طالب وطالبة.',
                'description_en' => 'Campaign to build a school in a remote village lacking educational facilities. The school will serve 200 students.',
                ...
                'impact_description_en' => 'The school will provide education for 200 students in the remote village.',
                'campaign_highlights' => [
            ...
            [
                'category_name_ar' => 'حملات الصحة',
                'title_ar' => 'حملة علاج الأطفال المصابين بالسرطان',
                'title_en' => 'Cancer Treatment Campaign for Children',
                'description_ar' => 'حملة لعلاج 50 طفل مصاب بالسرطان من الأسر المحتاجة. الحملة تغطي تكاليف العلاج والعمليات الجراحية.',
                'description_en' => 'Campaign to treat 50 children with cancer from needy families. The campaign covers treatment costs and surgeries.',
            ...
            [
                'category_name_ar' => 'حملات الإغاثة',
                ...
                'impact_description_en' => 'Will help provide basic assistance to 1000 refugees in camps.',
                'campaign_highlights' => [
            ...
            [
                'category_name_ar' => 'حملات البناء',
                'title_ar' => 'حملة بناء مسجد في الحي الفقير',
                'title_en' => 'Mosque Building Campaign in Poor Neighborhood',
            ...
            [
                ...
                'description_en' => 'Urgent campaign to help flood victims in the affected area. We need to provide shelter, food, and medicine.',
                ...
                'impact_description_en' => 'Will help provide relief to 300 families affected by floods.',
                'campaign_highlights' => [
            ...
            [
                ...
                'title_en' => 'Laptops for Needy Students Campaign',
                'description_ar' => 'حملة لتوفير أجهزة حاسوب محمولة للطلاب المحتاجين لتمكينهم من التعليم عن بعد.',
                'description_en' => 'Campaign to provide laptops for needy students to enable them for distance learning.',
                ...
                'impact_description_en' => 'Will provide laptops for 200 needy students to enable them for distance learning.',
                'campaign_highlights' => [
            ...
            [
                ...
                'title_en' => 'Free Medical Checkup Campaign for the Poor',
                'description_ar' => 'حملة لتوفير فحص طبي مجاني شامل للفقراء والمحتاجين في المناطق النائية.',
                'description_en' => 'Campaign to provide free comprehensive medical checkups for the poor and needy in remote areas.',
                ...
                'impact_description_en' => 'Will provide free medical checkups for 1000 poor and needy people.',
                'campaign_highlights' => [
